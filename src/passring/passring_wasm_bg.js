...
* @returns {(PublicKey)[]}
*/
export function get_random_ring(size) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_random_ring(retptr, size);
...
* @returns {any}
*/
export function strip_full_signature(full_signature) {
    const ret = wasm.strip_full_signature(addHeapObject(full_signature));
...
const PassringFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_passring_free(ptr >>> 0));
/**
*/
export class Passring {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        PassringFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_passring_free(ptr);
    }
    /**
    * @param {string} voting_id
    * @param {(PublicKey)[]} ring
    */
    constructor(voting_id, ring) {
        const ptr0 = passStringToWasm0(voting_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayJsValueToWasm0(ring, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.passring_new(ptr0, len0, ptr1, len1);
    ...
    * @returns {any}
    */
    issue(choice, private_key) {
        _assertClass(private_key, PrivateKey);
        var ptr0 = private_key.__destroy_into_raw();
        const ret = wasm.passring_issue(this.__wbg_ptr, choice, ptr0);
        return takeObject(ret);
    }
    /**
    * @param {any} full_signature
    * @returns {boolean}
    */
    validate(full_signature) {
        const ret = wasm.passring_validate(this.__wbg_ptr, addHeapObject(full_signature));
        return ret !== 0;
    }
    /**
    ...
    * @returns {boolean}
    */
    link(full_signature_1, full_signature_2) {
        const ret = wasm.passring_link(this.__wbg_ptr, addHeapObject(full_signature_1), addHeapObject(full_signature_2));
        return ret !== 0;
    }
}
...
export class PrivateKey {
    ...
    */
    static random() {
        const ret = wasm.privatekey_random();
    ...
    */
    encodeHex() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.privatekey_encodeHex(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    encodeHexUpper() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.privatekey_encodeHexUpper(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
...
export class PublicKey {
    ...
    */
    encodeHex() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.publickey_encodeHex(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    encodeHexUpper() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.publickey_encodeHexUpper(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
